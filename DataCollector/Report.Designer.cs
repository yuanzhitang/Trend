namespace MockClick
{
	partial class Report
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "TotalDoneTaskCount";
			...
			this.textBox1.Size = new System.Drawing.Size(801, 633);
			...
			this.button2.Text = "TotalStoryCount";
			...
			this.button3.Text = "TotalDoneStoryCount";
			...
			this.button4.Text = "TotalInCompleteStoryCount";
			...
			this.button5.Text = "TotalDoneStorySize";
			...
			this.button6.Text = "TotalDoneTaskSize";
			...
			this.button7.Text = "Large Task Top 10";
			this.button7.UseVisualStyleBackColor = true;
			this.button7.Click += new System.EventHandler(this.button7_Click);
			// 
			// button8
			// 
			this.button8.Location = new System.Drawing.Point(1033, 31);
			this.button8.Name = "button8";
			this.button8.Size = new System.Drawing.Size(224, 35);
			this.button8.TabIndex = 8;
			this.button8.Text = "CurrentSprintStoryCount";
			this.button8.UseVisualStyleBackColor = true;
			this.button8.Click += new System.EventHandler(this.button8_Click);
			// 
			// button9
			// 
			this.button9.Location = new System.Drawing.Point(1033, 72);
			this.button9.Name = "button9";
			this.button9.Size = new System.Drawing.Size(224, 35);
			this.button9.TabIndex = 9;
			this.button9.Text = "TotalStorySize";
			this.button9.UseVisualStyleBackColor = true;
			this.button9.Click += new System.EventHandler(this.button9_Click);
			// 
			// button10
			// 
			this.button10.Location = new System.Drawing.Point(1033, 164);
			this.button10.Name = "button10";
			this.button10.Size = new System.Drawing.Size(224, 35);
			this.button10.TabIndex = 10;
			this.button10.Text = "TotalTaskCount";
			this.button10.UseVisualStyleBackColor = true;
			this.button10.Click += new System.EventHandler(this.button10_Click);
			// 
			// button11
			// 
			this.button11.Location = new System.Drawing.Point(1033, 205);
			this.button11.Name = "button11";
			this.button11.Size = new System.Drawing.Size(224, 35);
			this.button11.TabIndex = 11;
			this.button11.Text = "TotalTaskSize";
